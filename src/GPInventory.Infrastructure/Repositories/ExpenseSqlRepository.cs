        ...
        using (var reader = await command.ExecuteReaderAsync())
        {
            while (await reader.ReadAsync())
            {
                ...
                var expense = new ExpenseWithDetailsDto
                {
                    ...
                    AmountUsd = reader.IsDBNull(reader.GetOrdinal("amount_usd")) ? null : reader.GetDecimal(reader.GetOrdinal("amount_usd")),
                    UsdExchangeRate = reader.IsDBNull(reader.GetOrdinal("usd_exchange_rate")) ? null : reader.GetDecimal(reader.GetOrdinal("usd_exchange_rate")),
