...
public class AuthController : ControllerBase
{
    ...
    /// <summary>
    /// Refresh token para mantener la sesión activa
    /// </summary>
    [HttpPost("refresh")]
    ...
    [HttpPost("logout")]
    [Authorize]
    public async Task<IActionResult> Logout([FromBody] RefreshTokenDto logoutDto)
    {
        try
        {
            var userEmail = User.FindFirst(System.Security.Claims.ClaimTypes.Email)?.Value;
            ...
            await _authService.LogoutAsync(userEmail, logoutDto.ClientApp);
